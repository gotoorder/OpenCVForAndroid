...
public class LivenessModel {
    ...
    private FaceImageInstance FaceImageInstance;
    ...
    //raysees bank union cetification test
    public byte[] nirData;
    public byte[] depthData;
    public int depthNear;

    public FaceImageInstance getFaceImageInstance() {
        return FaceImageInstance;
    }

    public void setFaceImageInstance(FaceImageInstance bdFaceImageInstance) {
        this.FaceImageInstance = bdFaceImageInstance;
    }
